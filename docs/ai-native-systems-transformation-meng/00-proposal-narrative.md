...
The program prepares STEM-plus graduates to diagnose complex systems, integrate AI responsibly, learn continuously, prototype practical interventions, and drive evidence-based transformation across domains. STEM-plus means engineering, computer science, data science, applied science, architecture/design, operations/systems, and related technical backgrounds.
...
Students begin industry immersion in Semester 1. They commit to a deep challenge by the end of Semester 1 and continue that challenge through prototype, field implementation, co-op or residency, scale planning, portfolio, and final defense. The co-op or residency is the field implementation phase of a supervised transformation project spine, not a detached work placement.
